...
const Signup = ({navigation}: {navigation: any}) => {
    ...
    const comp = () => {
        if (regex.test(pass) && validate(email)) {
            saveUser(id, name, user, pass,email);
            clean();
        } else {
    ...
    <View style={styles.container}>
        ...
        <Text style={styles.text3}>
            La contraseña Debe contener 8 caracteres, Una letra en mayúscula, Una letra en minúscula, Un numero y  Un carácter especial
        </Text>
        <TextInput
